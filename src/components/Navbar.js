        ...
        <nav className="bg-white shadow-md sticky top-0 z-50 w-full border-b border-gray-200">
            <div className="max-w-7xl mx-auto flex items-center justify-between px-4 py-2 gap-4">
                ...
                <Link to="/" className="flex items-center no-underline">
                    <img src="/logo.png" alt="VastraVilla" className="h-10" />
                </Link>
                ...
                <div className="flex-1 max-w-lg flex bg-gray-100 rounded-lg shadow-sm overflow-hidden border border-gray-300">
                    <input
                        type="text"
                        className="flex-1 border-none px-3 py-2 text-sm outline-none placeholder-gray-500 bg-gray-100"
                        placeholder="Search for clothes, occasions, events..."
                    />
                    <button className="bg-gray-100 border-none px-3 cursor-pointer hover:bg-gray-200 transition-colors">
                ...
                <div className="hidden md:flex items-center gap-4">
                    <Link to="/seller" className="text-gray-700 no-underline text-sm font-medium whitespace-nowrap px-2 py-1.5 rounded hover:bg-gray-100 transition-all flex items-center gap-2">
                ...
                <Link to="/cart" className="relative group">
                    <div className="text-gray-700 hover:bg-gray-100 p-1.5 rounded-full transition-all">
                        <svg
                ...
                {/* Login Button with Dropdown - Conditional based on user state */}
                {!user ? (
                    // Not logged in - Show Login button
                    <Link to="/login">
                        <button className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-5 py-1.5 rounded-lg text-sm font-semibold shadow-md hover:from-purple-700 hover:to-pink-700 hover:shadow-lg transition-all whitespace-nowrap flex items-center gap-2">
